...
class CapitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create capital" do
    assert_difference('Capital.count') do
      post capitals_url, params: { capital: { country_id: @capital.country_id, name: @capital.name, population: @capital.population } }
    end
  ...
  test "should update capital" do
    patch capital_url(@capital), params: { capital: { country_id: @capital.country_id, name: @capital.name, population: @capital.population } }
