...
class AttractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post attractions_url, params: { attraction: { country_id: @attraction.country_id, description: @attraction.description, name: @attraction.name } }
    end
  ...
  test "should update attraction" do
    patch attraction_url(@attraction), params: { attraction: { country_id: @attraction.country_id, description: @attraction.description, name: @attraction.name } }
